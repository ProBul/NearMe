...
public class DBHelperFavorite extends SQLiteOpenHelper {
    ...
    public DBHelperFavorite(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
        super(context, Constants.DATABASE_NAME_FAVORITE, null, Constants.DATABASE_VERSION);
    }
